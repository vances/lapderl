The `lapderl` application is a protocol stack implementation of the link access procedures for the D-channel as specified in ITU-T Q.921 ISDN user-network interface - Data link layer specification.
